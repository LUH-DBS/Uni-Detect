...
def get_tokens_dict(train_path: str, output_path: str, file_type: str, executor: ThreadPoolExecutor, n_cells_limit: int) -> dict:
    ...
    for path in train_path:
        executor_features.append(executor.submit(get_table_tokens_dict, path, file_type, n_cells_limit, output_path))
...
def get_table_tokens_dict(table_path: str, file_type: str, n_cells_limit: int, output_path: str) -> set:
    """
